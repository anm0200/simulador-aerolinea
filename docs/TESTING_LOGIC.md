...
- **Error Crítico**:
  ...
  ```
- **Fallo de Configuración Estándar**: A pesar de definir un `setupFiles` en la configuración, los _Worker Threads_ de Vitest perdían la referencia de inicialización de Angular.
...
- **Heurística**: Se emplea la distancia _Haversine_ desde el nodo actual al destino como guía.

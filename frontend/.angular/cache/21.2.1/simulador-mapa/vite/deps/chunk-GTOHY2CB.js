import { BehaviorSubject, Observable, Subject, Subscription, map } from './chunk-RSS3ODKE.js';
...
function runLeaveAnimationsWithCallback(lView, tNode, injector, callback) {
  ...
  addToAnimationQueue(
    injector,
    () =>
      executeLeaveAnimations(lView, tNode, animations || void 0, nodesWithExitAnimations, callback),
    animations || void 0,
  );
}
  ...
  return makeEnvironmentProviders([
    ...
    provideAppInitializer(() => {
      ...
      ngZone.runOutsideAngular(() => {
        const timeoutId = setTimeout(() => {
          console.debug(
            `---- Application did not stabilize within ${STABILITY_WARNING_THRESHOLD / 1e3} seconds ----`,
          );
...
//# sourceMappingURL=chunk-GTOHY2CB.js.map

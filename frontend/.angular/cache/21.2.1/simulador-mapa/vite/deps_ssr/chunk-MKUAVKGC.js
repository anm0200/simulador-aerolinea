...
import { Title } from './chunk-6B7DDZFM.js';
import {
...
import { LOCATION_INITIALIZED, PlatformLocation } from './chunk-ZOTRC4OH.js';
import {
...
function matchWithChecks(
  ...
  return runCanMatchGuards(
    ...
    currentSnapshot,
    abortSignal,
  ).pipe((0, import_operators.map)((v) => (v === true ? result : __spreadValues({}, noMatch))));
}
      ...
      (0, import_operators.switchMap)((overallTransitionState) => {
        ...
        return (0, import_rxjs.of)(overallTransitionState).pipe(
            ...
            if (this.urlHandlingStrategy.shouldProcessUrl(t.rawUrl)) {
              return (0, import_rxjs.of)(t).pipe(
                ...
                (0, import_operators.switchMap)((value) =>
                  (0, import_rxjs.from)(
                    overallTransitionState.routesRecognizeHandler.deferredHandle ??
                      (0, import_rxjs.of)(void 0),
                  ).pipe((0, import_operators.map)(() => value)),
                ),
          ...
          (0, import_operators.switchMap)((t) => {
            ...
            return deferred
              ? (0, import_rxjs.from)(deferred.then(() => t))
              : (0, import_rxjs.of)(t);
          }),
...
//# sourceMappingURL=chunk-MKUAVKGC.js.map

...
import { ActivatedRoute, ROUTES, Router, loadChildren } from './chunk-MKUAVKGC.js';
import {
  BrowserDomAdapter,
  BrowserModule,
  EVENT_MANAGER_PLUGINS,
  EventManagerPlugin,
} from './chunk-6B7DDZFM.js';
import { HTTP_ROOT_INTERCEPTOR_FNS } from './chunk-XN6FPAPI.js';
import {
  APP_BASE_HREF,
  NullViewportScroller,
  PLATFORM_SERVER_ID,
  ViewportScroller,
} from './chunk-DP2KGMHZ.js';
import { PlatformLocation, XhrFactory, getDOM, setRootDomAdapter } from './chunk-ZOTRC4OH.js';
import {
  APP_ID,
  ApplicationRef,
  CSP_NONCE,
  ...
  ɵɵdefineNgModule,
  ɵɵinject,
} from './chunk-6K7PNESI.js';
import { require_cjs } from './chunk-O5J3CNTX.js';
...
var ServerXhr = class _ServerXhr {
  ...
  async ɵloadImpl() {
    if (!this.xhrImpl) {
      const { default: xhr } = await import('./xhr2-E5RTESSH.js');
      this.xhrImpl = xhr;
    }
  }
  build() {
...
var Beasties = class _Beasties {
  ...
  async process(html) {
    ...
    if (this.options.external !== false) {
      ...
      const hasCustomEmbed =
        this.embedLinkedStylesheet !== _Beasties.prototype.embedLinkedStylesheet;
      if (hasCustomEmbed) {
  ...
  async getCssAsset(href, _style) {
    ...
    if (
      ...
      !(pathPrefix === '/' && normalizedPath.startsWith('//'))
    ) {
  ...
  processStyle(style, document2) {
    ...
    const astInverse = options.pruneSource
      ? parseStylesheet(sheet, { safeParser: this.options.safeParser !== false })
      : null;
    let criticalFonts = '';
...
var IS_DISCOVERING_ROUTES = new InjectionToken(
...
//# sourceMappingURL=chunk-TLQHNJYW.js.map

...
import { PlatformLocation, XhrFactory, parseCookieValue } from './chunk-ZOTRC4OH.js';
import {
...
var HttpInterceptorHandler = class _HttpInterceptorHandler {
  ...
  handle(initialRequest) {
    ...
    if (this.contributeToStability) {
      ...
      ).pipe((0, import_operators.finalize)(removeTask));
    } else {
      return this.chain(initialRequest, (downstreamRequest) =>
        this.backend.handle(downstreamRequest),
      );
...
//# sourceMappingURL=chunk-XN6FPAPI.js.map

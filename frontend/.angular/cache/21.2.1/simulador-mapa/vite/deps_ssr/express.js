...
import { __commonJS, __require, __spreadProps, __spreadValues } from './chunk-6DU2HRTW.js';
  ...
  'node_modules/on-finished/index.js'(exports, module) {
    ...
    function isFinished(msg) {
      ...
      if (typeof msg.complete === 'boolean') {
        return Boolean(
          msg.upgrade || !socket || !socket.readable || (msg.complete && !msg.readable),
        );
      }
      return void 0;
    }
  ...
  'node_modules/mime-types/index.js'(exports) {
    ...
    function _preferredTypeLegacy(ext, type0, type1) {
      ...
      if (
        ...
        (score0 > score1 ||
          (score0 === score1 && exports.types[extension]?.slice(0, 12) === 'application/'))
      ) {
        return type0;
      }
      return score0 > score1 ? type0 : type1;
    ...
    var merge = function merge2(target, source, options) {
      ...
      if (!target || typeof target !== 'object') {
        if (isOverflow(source)) {
          ...
          var result =
            options && options.plainObjects ? { __proto__: null, 0: target } : { 0: target };
  ...
  'node_modules/qs/lib/parse.js'(exports, module) {
    ...
    var normalizeParseOptions = function normalizeParseOptions2(opts) {
      ...
      return {
        ...
        strictMerge:
          typeof opts.strictMerge === 'boolean' ? !!opts.strictMerge : defaults.strictMerge,
        strictNullHandling:
          typeof opts.strictNullHandling === 'boolean'
            ? opts.strictNullHandling
            : defaults.strictNullHandling,
      ...
      try {
        ...
        if (isPromise(ret)) {
          if (!(ret instanceof Promise)) {
            deprecate(
              'handlers that are Promise-like are deprecated, use a native Promise instead',
            );
          }
      ...
      function paramCallback(err) {
        ...
        try {
          ...
          if (isPromise(ret)) {
            if (!(ret instanceof Promise)) {
              deprecate(
                'parameters that are Promise-like are deprecated, use a native Promise instead',
              );
            }
            ret.then(null, function (error) {
  ...
  'node_modules/express/lib/application.js'(exports, module) {
    ...
    app.render = function render(name, options, callback) {
      ...
      var renderOptions = __spreadValues(
        __spreadValues(__spreadValues({}, this.locals), opts._locals),
        opts,
      );
    ...
    function format(obj) {
      ...
      if (parameters && typeof parameters === 'object') {
        ...
        for (var i = 0; i < params.length; i++) {
          param = params[i];
          var val =
            param.slice(-1) === '*' ? ustring(parameters[param]) : qstring(parameters[param]);
          string += '; ' + param + '=' + val;
        }
      }
      return string;
...
var require_send = __commonJS({
  'node_modules/send/index.js'(exports, module) {
    ...
    function SendStream(req, path2, options) {
      ...
      this._extensions =
        opts.extensions !== void 0 ? normalizeList(opts.extensions, 'extensions option') : [];
      this._immutable = opts.immutable !== void 0 ? Boolean(opts.immutable) : false;
      this._index =
        opts.index !== void 0 ? normalizeList(opts.index, 'index option') : ['index.html'];
...
var require_response = __commonJS({
  'node_modules/express/lib/response.js'(exports, module) {
    ...
    res.contentType = res.type = function contentType(type) {
      var ct =
        type.indexOf('/') === -1 ? mime.contentType(type) || 'application/octet-stream' : type;
    ...
    res.clearCookie = function clearCookie(name, options) {
      const opts = __spreadProps(__spreadValues({ path: '/' }, options), {
